...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.sugarAdd.setText(_translate("Form", "Extra"))
        ...
        self.milkAdd.setText(_translate("Form", "Extra"))
